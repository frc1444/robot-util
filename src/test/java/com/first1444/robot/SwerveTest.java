...
import com.first1444.robot.drivetrains.swerve.FourSwerveCollection;
import com.first1444.robot.drivetrains.swerve.FourWheelSwerveDrive;
import com.first1444.robot.drivetrains.swerve.ImmutableFourSwerveCollection;
import com.first1444.robot.drivetrains.swerve.SwerveModule;
import com.first1444.robot.util.DefaultPerspective;
import com.first1444.robot.util.MathUtil;
...
final class SwerveTest {
	...
	void testStraightSwerve(){
		testStraightSwerve(90, 1, 90,0, 1, 1, DefaultPerspective.VIEWING_NORMAL);
		testStraightSwerve(90, 1, 0,1, 0, 1, DefaultPerspective.VIEWING_NORMAL);
		testStraightSwerve(90, 1, -90,0, -1, 1, DefaultPerspective.VIEWING_NORMAL);
		testStraightSwerve(90, 1, 180,-1, 0, 1, DefaultPerspective.VIEWING_NORMAL);
	}
	@Test
...
//		final FourWheelSwerveDrive drive = new FourWheelSwerveDrive(() -> orientation, collection, 27.375, 22.25);
		drive.setControl(0, 0, 1, 1.0, DefaultPerspective.VIEWING_NORMAL); // turn right
		drive.update();
	}
	@Test
